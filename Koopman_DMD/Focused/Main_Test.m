...
order = 4;
count = 1;
% [name,enderr,avgerr] = DMDcartpendEDMDFFT(x0,xf,duration,count,order);
[name,enderr,avgerr] = DMDcartpendEDMDPOLY(x0,xf,duration,count);
...
% 
% count = 1;
% [name,enderr,avgerr] = DMDpendEDMDEK_FFT2(x0,xf,duration,count);

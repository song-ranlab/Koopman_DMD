...
function [xHistory, uHistory, tHistory, rHistory] = runMPC(syshandle, Duration,Ts,N,Nu,x0, ObjectiveFCN, ConstraintFCN, Q, R, Ru, options, xref, pest, Xapx)
...
for ct = 1:Nt-1
    ...
    COSTFUN = @(u) ObjectiveFCN_EDMDc(u,xhat,N,Nu,xref,uHistory(:,ct),pest,Q,R,Ru,Xapxn);

...
ModelName = 'Pendulum_Inverted_DMD_';
...
[Phi ,omega ,Atilde ,b,Xdmd] = myDMD(y2,4,dt);
[Phi2 ,omega2 ,Atilde2 ,bc,Xdmd2] = myDMD(y1,4,dt);
...
for i = 1:length(Xdmd(1,:)) 
    for k = 1:length(Xdmd(:,1))
        error1(k,i) = (y2(k,i)-Xdmd(k,i))^2/y2(k,i)^2;
        error2(k,i) = (y1(k,i)-Xdmd2(k,i))^2/y1(k,i)^2;
    end
end
...
ylabel('X')
title('State 1')
title('DMD with no Control - State 1')
...
xlabel('t - centiseconds')
ylabel('X''')
title('DMD with no Control - State 2')
...
xlabel('t - centiseconds')
ylabel('\theta')
title('DMD with no Control - State 3')
...
xlabel('t - centiseconds')
ylabel('\theta''')
title('DMD with no Control - State 4')
...
xlabel('t - centiseconds')
ylabel('Error')
title('DMD with no Control - Error')
...
xlabel('t - centiseconds')
ylabel('X')
title('DMD with Control - State 1')
...
xlabel('t - centiseconds')
ylabel('X''')
title('DMD with Control - State 2')
...
xlabel('t - centiseconds')
ylabel('\theta')
title('DMD with Control - State 3')
...
xlabel('t - centiseconds')
ylabel('\theta''')
title('DMD with Control - State 4')
